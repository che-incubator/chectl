...
OPTIONS
  ...
  -i, --cheimage=cheimage
      [default: quay.io/eclipse/che-server:7.15.1] Eclipse Che server container image
  ...
  --che-operator-image=che-operator-image
      [default: quay.io/eclipse/che-operator:7.15.1] Container image of the operator. This parameter is used only when the 
...
OPTIONS
  ...
  --che-operator-image=che-operator-image                                      [default:
                                                                               quay.io/eclipse/che-operator:7.15.1]
