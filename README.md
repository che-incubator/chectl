...
OPTIONS
  ...
  -i, --cheimage=cheimage
      [default: quay.io/eclipse/che-server:7.9.3] Eclipse Che server container image
  ...
  --che-operator-image=che-operator-image
      [default: quay.io/eclipse/che-operator:7.9.3] Container image of the operator. This parameter is used only when the 
...
OPTIONS
  ...
  --che-operator-image=che-operator-image                                      [default:
                                                                               quay.io/eclipse/che-operator:7.9.3]
