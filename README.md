...
OPTIONS
  ...
  --che-operator-image=che-operator-image
      [default: quay.io/eclipse/che-operator:7.23.2] Container image of the operator. This parameter is used only when the 
  ...
  --dev-workspace-controller-image=dev-workspace-controller-image
      [default: quay.io/devfile/devworkspace-controller:sha-1b7df8f] Container image of the dev workspace controller. This 
...
OPTIONS
  ...
  --che-operator-image=che-operator-image                  [default: quay.io/eclipse/che-operator:7.23.2] Container
