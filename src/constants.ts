 ...
 **********************************************************************/
 ...
 // images
export const DEFAULT_CHE_IMAGE = 'quay.io/eclipse/che-server:7.23.0'
export const DEFAULT_CHE_OPERATOR_IMAGE = 'quay.io/eclipse/che-operator:7.23.0'
export const DEFAULT_DEV_WORKSPACE_CONTROLLER_IMAGE = 'quay.io/devfile/devworkspace-controller:sha-e07ba5b'
