 ...
 **********************************************************************/
 ...
 // images
export const DEFAULT_CHE_IMAGE = 'quay.io/eclipse/che-server:7.23.2'
export const DEFAULT_CHE_OPERATOR_IMAGE = 'quay.io/eclipse/che-operator:7.23.2'
export const DEFAULT_DEV_WORKSPACE_CONTROLLER_IMAGE = 'quay.io/devfile/devworkspace-controller:sha-1b7df8f'
