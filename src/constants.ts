...
export const DOCS_LINK_HOW_TO_CREATE_USER_OS4 = 'https://docs.openshift.com/container-platform/4.1/authentication/understanding-identity-provider.html#identity-provider-overview_understanding-identity-provider'
...
export const ERROR_MESSAGE_NO_REAL_USER = 'No real user exists in the cluster. Either disable OpenShift OAuth integration("os-oauth" flag) or add at least one user (details in the Help link):'
