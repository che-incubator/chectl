 ...
 **********************************************************************/
 ...
 // images
export const DEFAULT_CHE_IMAGE = 'quay.io/eclipse/che-server:7.22.2'
export const DEFAULT_CHE_OPERATOR_IMAGE = 'quay.io/eclipse/che-operator:7.22.2'
export const DEFAULT_DEV_WORKSPACE_CONTROLLER_IMAGE = 'quay.io/devfile/devworkspace-controller:sha-990d5e1'
