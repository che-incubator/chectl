...
# Setup all necessary environment variables needed by e2e and Openshift CI
init() {
...
run() {
  ...
  yarn test --coverage=false --forceExit --testRegex=${CHECTL_REPO}/test/e2e/e2e-rollback.test.ts
}
