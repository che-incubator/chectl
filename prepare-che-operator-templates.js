...
function prepareTemplates() {
    if (fs.existsSync(deployFolder)) {
        ...
        fs.copySync(path.join(deployFolder, 'objects', 'che-operator.ServiceAccount.yaml'), path.join(cheOperatorTemplates, 'rbac', 'service_account.yaml'))
        fs.copySync(path.join(deployFolder, 'objects', 'che-operator.ClusterRoleBinding.yaml'), path.join(cheOperatorTemplates, 'rbac', 'cluster_rolebinding.yaml'))
        fs.copySync(path.join(deployFolder, 'objects', 'che-operator.ClusterRole.yaml'), path.join(cheOperatorTemplates, 'rbac', 'cluster_role.yaml'))
        fs.copySync(path.join(deployFolder, 'objects', 'che-operator.RoleBinding.yaml'), path.join(cheOperatorTemplates, 'rbac', 'role_binding.yaml'))
        fs.copySync(path.join(deployFolder, 'objects', 'che-operator.Role.yaml'), path.join(cheOperatorTemplates, 'rbac', 'role.yaml'))
        fs.copySync(path.join(deployFolder, 'objects', 'leader-election-role.Role.yaml'), path.join(cheOperatorTemplates, 'rbac', 'leader-election-role.yaml'))
        fs.copySync(path.join(deployFolder, 'objects', 'leader-election-rolebinding.RoleBinding.yaml'), path.join(cheOperatorTemplates, 'rbac', 'leader-election-rolebinding.yaml'))
        fs.copySync(path.join(deployFolder, 'objects', 'serving-cert.Certificate.yaml'), path.join(cheOperatorTemplates, 'crds', 'serving-cert.yaml'))
        fs.copySync(path.join(deployFolder, 'objects', 'selfsigned-issuer.Issuer.yaml'), path.join(cheOperatorTemplates, 'crds', 'selfsigned-issuer.yaml'))
        fs.copySync(path.join(deployFolder, 'objects', 'webhook-service.Service.yaml'), path.join(cheOperatorTemplates, 'crds', 'webhook-service.yaml'))
        fs.copySync(path.join(deployFolder, 'objects', 'manager-config.ConfigMap.yaml'), path.join(cheOperatorTemplates, 'crds', 'manager-config.yaml'))
